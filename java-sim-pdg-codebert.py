...
# Convert PDG to CodeBERT embedding
def pdg_to_codebert_embedding(pdg):
                            ...
                            for java_file in files:
                                if java_file.endswith('.java'):
                                    ...
                                    try:
                                        ...
                                        # Convert PDGs to CodeBERT embeddings
                                        embedding_1 = pdg_to_codebert_embedding(pdg_1)
                                        embedding_2 = pdg_to_codebert_embedding(pdg_2)
