...
def get_code_graph_embedding(code_snippet, embed_dim=16):
    ...
    g2v = Glove(n_components=embed_dim)  # Initialize GloVe with specified embedding dimension
    g2v.fit(graph)  # Fit GloVe on the entire graph
