...
def get_code_graph_embedding(code_snippet, embed_dim=16):
    ...
    # Generate embedding using GGVec
    g2v = GGVec(n_components=embed_dim)  # Initialize GGVec with specified embedding dimension
    g2v.fit(graph)  # Fit GGVec on the entire graph
